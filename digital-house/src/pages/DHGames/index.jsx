...
import './style.scss'
import { DHGamesItemRow } from './../../components/DHGamesItemRow'
import { DHGamesItemCard } from './../../components/DHGamesItemCard'
...
export function DHGames() {
    ...
    return (
        <>
            <div className='DHGames-main'>
                <h1 className='main-title'>DH Games</h1>
                <ul className='components-finded'>
                    <li>
                        {/* <img src={batataGif} alt="" /> */}
                        <h1>PROMOS OU DESCONTOZURAS?</h1>
                        <p>BANNER DO SITE - DESCRIÇÃO DO SITE</p>
                    </li>
                </ul>

                <h1 className='main-title'>New Games</h1>
                <div className="DHGames-new-games border">
                    {
                        newGames.map(
                            component => {
                                return (
                                    <DHGamesItemRow item={component} />
                                )
                            }
                        )
                    }
                ...
                <div className="DHGames-halloween-offers border">
                    {
                        halloweenGames.map(
                            component => {
                                return (
                                    <DHGamesItemCard item={component} />
                                )
                            }
                        )
                    }
